...
func TestTranslate_BG(t *testing.T) {
	...
	msgEvents := Translate("BG=8.9", time.Now().String())
...
func TestTranslate_BG_CARB(t *testing.T) {
	...
	msgEvents := Translate("BG=8.9 CHO=90", time.Now().String())
...
func TestTranslate_BG_CARB_BOLUS(t *testing.T) {
	...
	msgEvents := Translate("BG=8.9 CHO=90 SA=10", time.Now().String())
...
func TestTranslate_BG_CARB_BOLUS_BASAL(t *testing.T) {
	...
	msgEvents := Translate("BG=8.9 CHO=90 SA=10 LA=20", time.Now().String())
...
func TestTranslate_Bollocks(t *testing.T) {
	...
	msgEvents := Translate("blah blah", time.Now().String())
